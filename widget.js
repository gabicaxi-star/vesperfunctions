...
function renderStepLocation() {
  ...
  studioLabel.className = 'radio-label';
  const studioRadio = document.createElement('input');
  studioRadio.type = 'radio';
  studioRadio.name = 'location';
  studioRadio.value = 'studio';
  studioRadio.checked = state.location === 'studio';
  studioRadio.onchange = () => {
    state.location = 'studio';
    render();
  };
  studioLabel.appendChild(studioRadio);
  studioLabel.appendChild(document.createTextNode(' Vesper Studio (Downtown)'));
  frag.appendChild(studioLabel);

  frag.appendChild(document.createElement('br'));

  const offsiteLabel = document.createElement('label');
  offsiteLabel.className = 'radio-label';
  const offsiteRadio = document.createElement('input');
  offsiteRadio.type = 'radio';
  offsiteRadio.name = 'location';
  offsiteRadio.value = 'offsite';
  offsiteRadio.checked = state.location === 'offsite';
  offsiteRadio.onchange = () => {
    state.location = 'offsite';
    render();
  };
  offsiteLabel.appendChild(offsiteRadio);
  offsiteLabel.appendChild(document.createTextNode(' Offsite (your location)'));
  frag.appendChild(offsiteLabel);
...
function renderStepOccasion() {
  ...
  disclaimer.textContent = '*your requested date will be approved by staff to prevent double-bookings. availability is not guaranteed until first deposit is paid.';
